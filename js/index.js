...
document.addEventListener("DOMContentLoaded", function () {
  addPopupListeners("PopUpFall", "FallClose", "FallOK");
  addPopupListeners("PopUpMehf", "MehfClose", "MehfOK");
  addPopupListeners("PopUpflixi", "flixiClose", "flixiOK");
});
...
if (window.matchMedia("(max-width: 767px)").matches) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    button.addEventListener('click', function() {
      counter++;
      if (counter % 3 === 0) {
        desktop.style.backgroundImage = 'url(./images/homo.jpg)';
      } else if (counter % 2 === 1) {
        desktop.style.backgroundImage = 'url(./images/nice.jpeg)';
      } else {
        desktop.style.backgroundImage = 'url(./images/wp.gif)';
      }
    });
  });
}
